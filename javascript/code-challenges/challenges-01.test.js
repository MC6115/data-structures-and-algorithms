...
const addOne = (arr) => {
  const postAddOneArray = [];
  arr.forEach(element => {
    postAddOneArray.push(element + 1);
  });
  return postAddOneArray;
};
...
const addExclamation = (arr) => {
  const postAddExclamationArray = [];
  arr.forEach(element =>{
    postAddExclamationArray.push(element+'!');
  });
  return postAddExclamationArray;
};
...
const allUpperCase = (arr) => {
  const postAllUpperCaseArray = [];
  arr.forEach(element =>{
    postAllUpperCaseArray.push(element.toUpperCase());
  });
  return postAllUpperCaseArray;
};
...
const speaker = (words, callback) => {
  const postSpeaker = [];
  words.forEach(word => {
    postSpeaker.push(callback(word));
  });
  return postSpeaker;
};
